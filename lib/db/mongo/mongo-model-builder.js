...
module.exports = function DbModelBuilder(journal, Bookshelf) {
  const tapHandlers = {
    schemaDef: {},
    schema: {},
  };
  ...
  const pub = {
    ...
    run() {
      journal.forEach((node) => {
        ...
        //log.info('tapHandlers               ', tapHandlers);
        //log.info('tapHandlers.schemaDef     ', tapHandlers.schemaDef);
        //log.info('tapHandlers.schemaDef for ', node.capitalizedName());
