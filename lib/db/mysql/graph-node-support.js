import DbToGraphQLTypesMap from '../../utils/db-to-graphql-types-map.js';
import GraphqlMysqlResolveBuilder from '../../resolvers/graphql-mysql-resolve-builder.js';

const mysqlToGraphQLTypesMap = DbToGraphQLTypesMap('mysql');
...
export default function GraphNodeSupport(prot) {
